...
class CreatingStructure:
    ...
    def start(self):
        if os.path.exists(self.page):
            ...
            copin(os.path.join(der, 'text', 'Main.py'), os.path.join(self.main_file, 'Main.py'))
            d = open(os.path.join(der, 'text', '__main__.py'), 'r')
            ...
            shutil.copytree(os.path.dirname(der), os.path.join(self.diricrori, "PyForge"))
